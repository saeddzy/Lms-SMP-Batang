...
export default function Create() {
    const { classes = [], subjects = [], students = [], tasks = [], quizzes = [], exams = [] } = usePage().props;
    ...
    useEffect(() => {
        ...
        // Reset assessment selection when type or subject changes
        setData('assessment_id', '');
    ...
    return (
        <DashboardLayout title="Tambah Nilai Baru">
            <Head title="Tambah Nilai Baru" />
