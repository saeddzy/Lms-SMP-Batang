            ...
            <div className="mx-auto max-w-5xl">
                <div className="overflow-hidden rounded-lg border border-slate-200 bg-white">
                    ...
                    <div className="border-b border-slate-200 bg-slate-50/70 px-6 py-5">
                        <h2 className="text-xl font-semibold text-slate-900">Edit Materi Pembelajaran</h2>
                        <p className="mt-1 text-sm text-slate-500">
                            Perbarui detail materi agar konten tetap relevan dan mudah dipahami siswa.
                        </p>
                    </div>
                            ...
                            <div className="rounded-md border border-slate-200 bg-slate-50/50 p-4">
                                ...
                                {data.material_type === "video" && (
                                    <div className="space-y-4">
                                        <div>
                                            <Input.Label htmlFor="file" value="Ganti File Video (Opsional)" />
                                            <input
                                                id="file"
                                                type="file"
                                                onChange={handleFileChange}
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-xs text-slate-500">
                                                Isi URL jika materi berupa tautan video.
                                            </p>
                                        </div>
                                    </div>
                                )}
